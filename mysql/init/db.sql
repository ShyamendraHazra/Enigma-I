...
--
-- Host: localhost    Database: S_Y_S_T_E_M
-- ------------------------------------------------------
...
CREATE TABLE `daily_goals` (
  ...
  `goal_description` varchar(350) NOT NULL,
  PRIMARY KEY (`goal_id`),
...
--
-- Table structure for table `level_up_goals`
--

DROP TABLE IF EXISTS `level_up_goals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `level_up_goals` (
...
--
-- Dumping data for table `level_up_goals`
--

LOCK TABLES `level_up_goals` WRITE;
/*!40000 ALTER TABLE `level_up_goals` DISABLE KEYS */;
/*!40000 ALTER TABLE `level_up_goals` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-27 22:18:54
